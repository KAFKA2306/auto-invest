...
// Placeholder for future LLM/PDF fallback. Returns null for now.
const fetchWithLLMFallback = async (_symbol: string) => {
  return null as unknown as { quarter: string; eps: number; eps_yoy: number | null; source: string } | null;
};
